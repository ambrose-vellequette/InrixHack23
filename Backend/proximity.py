...
def checkProximity(parking_array, crime_array):
    ...
    CONV_LAT_TO_METER = 111132.954 - 559.822*cos(2.0 * lat_mid) + 1.175*cos(4*lat_mid)
    CONV_LONG_TO_METER = 111132.954 * 6367449 * cos(lat_mid)
    ...
    for crimes in crime_array:
        for streets in parking_array:
            ...
            long_dist = (float(crimes.long) - float(strees.long)) * CONV_LONG_TO_METER
